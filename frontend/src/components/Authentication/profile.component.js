    ...
    render() {
        ...
        return (
                <div className="pusher">
                    <div className="ui inverted vertical center aligned segment" id = {styles.masterhead} >
                        <div className="ui text container" id={styles.header}>
                            ...
                            <div className="ui huge primary button" onClick={this.logout}> Log Out <i className="right arrow icon"></i>
                            </div>
                        </div>
                    </div>
                </div>
