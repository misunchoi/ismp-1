    ...
    if(this.state.emailValid){
      AuthService.login(
         ...
         password
          ...
          myErr => {
           const { errors: {error}} = myErr.response.data
          ...
          <div className="column">
            ...
            <form className="ui large form" onSubmit={this.handleSubmit} >
              <div className="ui stacked segment">
                ...
                <button type="submit" disabled={!this.state.formValid} className="ui fluid large blue submit button">Login</button>
                  {this.state.errorMsg.authErrs && this.state.errorMsg.authErrs.map((error, i) => {
                  return  error ? (
              ...
              <div className="ui message">
                Don't have account yet? <a href="/register">Register an Account</a>
              </div>
            </form>
          </div>
        </div>
